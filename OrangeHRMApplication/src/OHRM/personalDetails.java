...
public class personalDetails extends AddEmployee {
	@Test(priority=9,description="Validating the Personal Details WebPAge")
	...
	@Test(priority=10,description="Validating Name Functionality")
	...
	Log.info("The Actual data in the Middle Name Of personal Details IS :-"+actual_lastNameOfPersonalDetails);
	...
	@Test(priority=11,description="Identifying  the PhotoGraph above Name functionality")
	public void PhotoAboveName() throws IOException
	{
		By photoAboveNameProperty=By.xpath(properties.getProperty("orangeHRMApplicationPersonalDetailsPhotoAboveNameProperty"));
		WebElement photoAboveName=driver.findElement(photoAboveNameProperty);
		String photoAboveNAme=photoAboveName.getText();
		Log.info("The text data name on the photo above is:-"+photoAboveNAme);
		cell=row.createCell(24);
		cell.setCellValue(photoAboveNAme);
		dataFile=new FileOutputStream("C:\\Users\\HP\\OneDrive\\Desktop\\ApplicationTesting\\OrangeHRMApplication\\Excel File\\OrangeHRM.xlsx");
        workbook.write(dataFile);
	}
